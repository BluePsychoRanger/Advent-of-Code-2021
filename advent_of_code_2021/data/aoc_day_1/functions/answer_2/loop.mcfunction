execute store result score a bpr_aoc run data get storage bpr:aoc Input[0]
execute store result score b bpr_aoc run data get storage bpr:aoc Input[1]
execute store result score c bpr_aoc run data get storage bpr:aoc Input[2]
...
execute if score i bpr_aoc matches 1.. if data storage bpr:aoc Input[-1] run function aoc_day_1:answer_2/loop
