...
execute if score direction bpr_aoc_data matches 4 run scoreboard players operation y bpr_aoc_data -= num bpr_aoc_data
execute if score direction bpr_aoc_data matches 6 run scoreboard players operation y bpr_aoc_data += num bpr_aoc_data
...
execute if score i bpr_aoc_data matches 1.. if data storage bpr:aoc Input[-1] run function aoc_day_2:answer_1/loop
