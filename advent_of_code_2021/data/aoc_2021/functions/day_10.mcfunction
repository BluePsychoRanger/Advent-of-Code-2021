...
scoreboard players set day bpr_aoc_answers 10
...
schedule function aoc_2021:logic/day_10/answer_1/run 1s


data modify storage bpr:aoc Input2 set from storage bpr:aoc MasterInput
schedule function aoc_2021:logic/day_10/answer_2/run 2s
