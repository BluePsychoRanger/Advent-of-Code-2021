execute store result score current bpr_aoc run data get storage bpr:aoc Input1[0]
...
execute if score i bpr_aoc matches 1.. if data storage bpr:aoc Input1[-1] run function aoc_2021:logic/day_1/answer_1/loop
