...
function aoc_2021:logic/day_11/answer_2/init/check_adjacent

scoreboard players remove i bpr_aoc 1
data remove storage bpr:aoc temp_in[0]
execute if score i bpr_aoc matches 1.. positioned ~ ~ ~1 run function aoc_2021:logic/day_11/answer_2/init/check_rows
