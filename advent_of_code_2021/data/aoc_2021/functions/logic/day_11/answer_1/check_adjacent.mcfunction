execute if block ~ ~ ~ lime_concrete run function aoc_2021:logic/day_11/answer_1/flash
...
execute if score j bpr_aoc matches 1.. positioned ~1 ~ ~ run function aoc_2021:logic/day_11/answer_1/check_adjacent
