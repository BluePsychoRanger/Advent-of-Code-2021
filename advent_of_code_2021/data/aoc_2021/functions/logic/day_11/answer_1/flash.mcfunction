...
execute positioned ~-1 ~ ~-1 if block ~ ~ ~ lime_concrete run function aoc_2021:logic/day_11/answer_1/flash
execute positioned ~-1 ~ ~ if block ~ ~ ~ lime_concrete run function aoc_2021:logic/day_11/answer_1/flash
execute positioned ~-1 ~ ~1 if block ~ ~ ~ lime_concrete run function aoc_2021:logic/day_11/answer_1/flash
execute positioned ~ ~ ~-1 if block ~ ~ ~ lime_concrete run function aoc_2021:logic/day_11/answer_1/flash
execute positioned ~ ~ ~1 if block ~ ~ ~ lime_concrete run function aoc_2021:logic/day_11/answer_1/flash
execute positioned ~1 ~ ~-1 if block ~ ~ ~ lime_concrete run function aoc_2021:logic/day_11/answer_1/flash
